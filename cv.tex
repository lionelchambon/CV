...
Current GPA: 3.8 (French scale: 15,20/20)
...
\textit{Cum laude} distinction. GPA: 4.0 (French scale: 16,45/20)
\begin{itemize}[noitemsep, topsep=0pt, left=0.65cm]
...
\noindent
\textbf{Programming:} R, Julia, EViews, Stata, Git (version control) \\
...
\textbf{Dynamic Programming}: Aiyagari Model
...
\noindent
\textbf{Languages}: German, French (both native), English (C2), Arabic (B2), Tunisian Arabic dialect (A2) \\
\noindent
...
\vspace{1cm}
\begin{FlushRight}
        \textit{Last updated: February 2025}
\end{FlushRight}
